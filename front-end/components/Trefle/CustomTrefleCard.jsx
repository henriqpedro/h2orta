                ...
                <>
                    <View className="justify-center items-center">
                        <TouchableOpacity
                            ...
                            className='z-10 self-end min-w-[70vw] min-h-[48px] justify-center items-end'>
                            <Entypo name="dots-three-horizontal" size={24} color="black" />
                            {
                                showMenu ?
                                    <CustomButton
                                        ...
                                        constainerStyles='absolute top-10 bg-primary rounded-xl'
...
export default CustomTrefleCard